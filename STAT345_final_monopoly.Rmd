...
player <- setRefClass("player", fields = list(pos="numeric", verbose='logical', jail = "numeric", rolldouble = "numeric"), method = list(move_n = function(n){if(verbose) cat("Player at:", pos)
if(verbose) cat(" Player moves:", n)
pos <- pos + n
if(pos > 40){
 pos = pos - 40}
...
if(verbose) cat(" Player now at:", pos,"\n")
return(pos)}, go_2_space_n = function(n){if(verbose) cat("Player at:", pos,".")
pos <-  n
