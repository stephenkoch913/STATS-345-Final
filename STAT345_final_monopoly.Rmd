...
player <- setRefClass("player", fields = list(pos="numeric", verbose='logical'), method = list(move_n = function(n){if(verbose) cat("Player at:", pos)
if(verbose) cat(" Player moves:", n)
pos <- pos + n
if(pos > 40){
 pos = pos - 40}
...
pos <-  n
if(verbose) cat("Player at:", pos,".")}, trap = function(n){}, getout = function(n){}, gotojail = function(n){
if(verbose) cat("Player at:", pos,".")
if (pos == 31) (pos = 11)
if(verbose) cat("Player in Jail")}))
```
