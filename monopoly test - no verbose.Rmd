...
#each player is initialized with three feilds pos, jail, and rolldouble set to values for starting the game
for(i in 1:1000){
  ...
  #take turn function is called with inputs of the specifc player and space tracking
  for(i in 1:30){
